...
export default class ApduParser {
    static parseResponseApdu(frames: GetResponseFrame[]): GetResponseNormal<import("../data-type/base/AbsBaseDataType.js").AbsBaseDataType<any>> | GetResponseNormalList | GetResponseRecord | GetResponseRecordList | ParseResult<null>;
}
