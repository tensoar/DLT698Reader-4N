...
export default class FrameCodec {
    static checkFrame(buf: ByteBuf) {
        ...
        const headerBytes: number[] = [buf.at(markIndex +1), buf.at(markIndex + 2), buf.readUInt8(), buf.readUInt8()];
    ...
    static extralContentLength(buf: ByteBuf) {
